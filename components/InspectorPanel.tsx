  ...
  return (
    <div className="w-80 border-l bg-card border-border overflow-y-auto h-full flex flex-col">
      <div className="p-4 border-b border-border sticky top-0 bg-card">
        ...
        <p
          className={`text-xs mt-1 font-medium ${getTypeColor(selectedNode.data.type)}`}
        >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {selectedNode.data.type === "decision" && (
          <Card className="p-4">
            ...
            <select
              ...
              onChange={(e) =>
                handleConfigChange("decisionType", e.target.value)
              }
        ...
        {selectedNode.data.type === "automation" &&
          selectedNode.data.id?.includes("sla") && (
            <Card className="p-4">
              <label className="text-sm font-semibold text-foreground block mb-2">
        ...
        {selectedNode.data.type === "automation" &&
          selectedNode.data.id?.includes("assign") && (
            <Card className="p-4">
              <label className="text-sm font-semibold text-foreground block mb-2">
                Assign To
              </label>
        ...
        {selectedNode.data.type === "automation" &&
          selectedNode.data.id?.includes("notify") && (
            <Card className="p-4">
              <label className="text-sm font-semibold text-foreground block mb-2">
